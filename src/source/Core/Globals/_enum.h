...
namespace SEASON3B
{
    enum INTERFACE_LIST
    {
        ...
        INTERFACE_OPTION,
        INTERFACE_VISUAL_QUALITY_OPTION,
        INTERFACE_HELP,
        ...
        INTERFACE_HELPER_SESSION_STATUS,
        INTERFACE_JEWELBANK,
...
enum ActionSkillType
{
    ...
    AT_SKILL_ALICE_DRAINLIFE_MASTERY = 462,
...
const std::map<ActionSkillType, ActionSkillType> SKILL_REPLACEMENTS = {
    ...
    { AT_SKILL_ALICE_DRAINLIFE_MASTERY, AT_SKILL_ALICE_DRAINLIFE_STR },
    { AT_SKILL_ALICE_CHAINLIGHTNING_STR, AT_SKILL_ALICE_CHAINLIGHTNING },
    { AT_SKILL_ALICE_BERSERKER_STR, AT_SKILL_ALICE_BERSERKER },
    { AT_SKILL_BerserkerProficiency, AT_SKILL_ALICE_BERSERKER_STR },
